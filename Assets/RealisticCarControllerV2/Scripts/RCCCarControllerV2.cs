...
public class RCCCarControllerV2 : MonoBehaviour {
	...
	private Vector3 defGasPedalPosition;		// Caching Default Brake Pedal Position In Case Of Using Accelerometer.
	...
	void Start (){
		...
		ControlType = GameManager.Instance.controlsType;
	...
	public void MobileGUI (){
		...
		if(mobileController){
			if(_mobileControllerType == MobileGUIType.NGUIController){
				...
				defbrakePedalPosition = brakePedalUI.transform.position;//+ new Vector3 (50, 0,0);
				defGasPedalPosition = gasPedalUI.transform.position;
			}
		}
		...
		if(canControl){
			...
			if(useAccelerometerForSteer && mobileController){
				...
				if(_mobileControllerType == MobileGUIType.UIController){
					...
					if(brakePedalUI){
						gasPedalUI.transform.position = defGasPedalPosition - new Vector3(0,80,0);
						brakePedalUI.transform.position = leftArrowUI.transform.position + new Vector3(135,15,0);
				...
				if(_mobileControllerType == MobileGUIType.UIController){
					...
					if(brakePedalUI){
						...
						gasPedalUI.transform.position = defGasPedalPosition;
					}
				}
	...
	public int ControlType
	{
		...
		set
		{
			...
			case 1:
				...
				steeringWheelControl = false;
				GameManager.Instance.controlsType = 1;
				break;
			case 2:
				steeringWheelControl = false;
				useAccelerometerForSteer = true;
				GameManager.Instance.controlsType = 2;
				break;
			case 3:
				useAccelerometerForSteer = false;
				steeringWheelControl = true;
				GameManager.Instance.controlsType = 3;
				break;
			}
		}
	}
